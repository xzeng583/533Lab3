...
// /___/   /\     Timestamp : 01/30/2025 21:29:17
// \   \  /  \ 
//  \___\/\___\ 
//
//Command: C:\Xilinx\10.1\ISE\bin\nt\unwrapped\sch2verilog.exe -intstyle ise -family virtex2 -w "C:/Documents and Settings/student/isetest/isim/lab3/dropfifo.sch" dropfifo.vf
...
module dropfifo(clk, 
   ...
   COMP8_MXILINX_dropfifo XLXI_5 (.A(waddr[7:0]), 
                                  .B(raddr[7:0]), 
                                  .EQ(XLXN_25));
   // synthesis attribute HU_SET of XLXI_5 is "XLXI_5_18"
   COMP8_MXILINX_dropfifo XLXI_6 (.A(raddr[7:0]), 
                                  .B(XLXN_16[7:0]), 
                                  .EQ(XLXN_26));
   ...
   OR2 XLXI_12 (.I0(XLXN_13), 
                .I1(XLXN_12), 
                .O(XLXN_11));
   AND2B1 XLXI_13 (.I0(XLXN_8), 
                   .I1(XLXN_11), 
                   .O(XLXN_7));
   AND3B2 XLXI_14 (.I0(XLXN_26), 
                   .I1(XLXN_25), 
                   .I2(fiforead), 
                   .O(XLXN_32));
   SDPM9B XLXI_15 (.addra(waddr[7:0]), 
                   .addrb(raddr[7:0]), 
                   .clka(clk), 
                   .clkb(clk), 
                   .dina(XLXN_34[71:0]), 
                   .wea(XLXN_24), 
                   .doutb(out_fifo[71:0]));
   VCC XLXI_16 (.P(XLXN_40));
   CB8CLE_MXILINX_dropfifo XLXI_17 (.C(clk), 
                                    .CE(XLXN_24), 
                                    .CLR(rst), 
                                    .D(XLXN_16[7:0]), 
                                    .L(XLXN_8), 
                                    ...
                                    .Q(waddr[7:0]), 
                                    .TC());
   // synthesis attribute HU_SET of XLXI_17 is "XLXI_17_20"
   CB8CE_MXILINX_dropfifo XLXI_18 (.C(clk), 
                                   .CE(XLXN_32), 
                                   .CLR(rst), 
                                   .CEO(), 
                                   .Q(raddr[7:0]), 
                                   .TC());
   // synthesis attribute HU_SET of XLXI_18 is "XLXI_18_21"
endmodule
